...
namespace WebBanDT.Models
{
    public class ApplePhone
    {
        ...
        public SelectList ApplePhoneList { get; set; }
        public List<ApplePhone> GetHome()
        {
            List<ApplePhone> strList = new List<ApplePhone>();
            ...
            string sql1 = @"select Phone.Id as 'maDT', Phone.Name as 'PhoneName', Phone.[Image], Manufacturer.[Name] as 'NameNSX',Price, [Status], [configuration] from Phone,Manufacturer where Phone.Manufacturerid = Manufacturer.Id and Manufacturer.Name ='Apple'";

...
namespace WebBanDT.Models
{
    public class Giatangdan
    {
        ...
        public SelectList GiatangdanList { get; set; }
        public List<Giatangdan> GetHome()
        {
            List<Giatangdan> strList = new List<Giatangdan>();
            ...
            string sql1 = @"select Phone.Id as 'maDT', Phone.Name as 'PhoneName', Phone.[Image], Manufacturer.[Name] as 'NameNSX',Price, [Status], [configuration] from Phone,Manufacturer where Phone.Manufacturerid = Manufacturer.Id order by Phone.Price ASC";
